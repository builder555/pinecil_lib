...
live_data = [
    MagicMock(
        ...
        raw_value=bytearray(
            b"!\x00\x00\x006\x01\x00\x00x\x00\x00\x00\x1d\x01\x00\x00\x00\x00\x00"
            + b"\x00\x03\x00\x00\x00P\x00\x00\x00<,\x00\x00\xc7*\x00\x00\xc3\x01\x00"
            + b"\x00\x1e\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
        ),
